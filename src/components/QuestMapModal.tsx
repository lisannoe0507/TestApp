...
// Shown when tapping a saved quest — a focused map on that one location,
// rather than a full discovery map (see the profile briefing: swiping stays
// the primary way to find things, this is just "where is this exactly").
  ...
  return (
    <Modal visible={!!quest} animationType="slide" presentationStyle="pageSheet" onRequestClose={onClose}>
      <SafeAreaView style={styles.container} edges={["top"]}>
        ...
        >
          <Marker coordinate={{ latitude: quest.latitude, longitude: quest.longitude }} pinColor={accent} />
        </MapView>
